...
<body class="page-top" id="page-top">
  <hr class="featurette-divider">
    ...
    <div class="row">
      <div class="col-md-4 ms-md-5 example">
    ...
    <div class="row ">
      <div class="col-md-6 info">
        <div class="col-auto topToF ms-3 me-3"><h2 id="nome" class="featurette-heading shadowT">Cristian Andrei <span class="text-muted">Mai Mihai</span></h2>

                                        ...
                                        <?php
                                            ...
                                            foreach ($tuples as $tuple) { 
                                                ...
                                                <tr class="table-<?php if($tuple['sesso']==0) echo 'dark';?>">
                                                    <td scope="row"><p><?php echo $tuple['username'];?></p></td>
                                                    <td ><p><?php echo $tuple['nome'];?></p></td>
                                                    <td ><p><?php echo $tuple['cognome'];?></p></td>
                                                    <td ><p><?php echo $tuple['dataNascita'];?></p></td>
                                                    <td ><p><?php echo $tuple['sesso'];?></p></td>
                                                    <td ><p><?php echo $tuple['email'];?></p></td>

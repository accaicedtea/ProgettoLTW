    ...
    <div class="container-fluid sfondo-animato">
        <div class="row row-cols-1  row-cols-md-2 ">
            ...
            <div class="col mt-5 ">
                        ...
                        <form action="./change_profile.php" method="post" name="form-change-profile" class="form-change-profile">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div>
                                        <button class="btn btn-primary btn-sm" id="submit-button">Salva cambiamenti</button>
                                    </div>
                                </div>
                            </div>
                    </div>
                ...
                <div class="col">
                <div class="form-floating mb-3">
                <input type="number" class="form-control " id="saldo" name="saldo" onchange="validaInput('saldo','[0-9]{1,32}')" pattern="[0-9]]{1,32}">
                <label for="saldo">Saldo</label>
                </div>
                <div class="form-floating mb-3">
                <input type="email" class="form-control " id="email" name="email" placeholder="email@example.com" onchange="validaInput('email','[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$')" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
